...
exports.SCOPE_PROTOTYPE = exports.SCOPE_SINGLETON = exports.Container = undefined;
...
var SCOPE_SINGLETON = "singleton";
var SCOPE_PROTOTYPE = "prototype";
...
var Container = function () {
  ...
  _createClass(Container, [{
    ...
    value: function getClass(name) {
      ...
      if (this._classes.get(name).scope === SCOPE_PROTOTYPE) return this._createInstance(name);
...
exports.SCOPE_SINGLETON = SCOPE_SINGLETON;
exports.SCOPE_PROTOTYPE = SCOPE_PROTOTYPE;
...
var Clazz = exports.Clazz = function () {
  function Clazz(name) {
    ...
    var scope = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _index.SCOPE_SINGLETON;
